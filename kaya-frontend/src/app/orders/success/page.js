  ...
  return (
    <div className="max-w-md w-full bg-[#111] border border-white/5 p-10 rounded-3xl shadow-2xl text-center relative z-10 animate-in zoom-in-95 duration-500">
      ...
      <div className="flex flex-col gap-3">
        <Link 
          href="/orders" 
          className="w-full px-6 py-4 bg-emerald-600 text-white rounded-xl text-xs font-bold tracking-widest uppercase hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-900/20 flex items-center justify-center gap-2"
        >
...
// 2. Wrap it in Suspense in the main default export
export default function OrderSuccessPage() {
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      {/* Suspense Boundary */}
      <Suspense fallback={
        <div className="text-emerald-500 font-bold tracking-widest uppercase text-xs animate-pulse relative z-10">
